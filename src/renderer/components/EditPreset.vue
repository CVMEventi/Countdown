<template>
  <div class="mt-1 flex rounded-md shadow-xs">
    ...
    <button @click="$emit('delete', $event)" type="button" class="-ml-px relative inline-flex items-center space-x-2 px-2 py-1 border border-zinc-700 text-sm font-medium rounded-r-md border-l-zinc-600 text-gray-700 bg-zinc-700 hover:bg-zinc-600 focus:outline-hidden focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
